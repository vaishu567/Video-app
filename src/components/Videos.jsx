    ...
    <Stack direction={["column",'row']} h={"100vh"} >
        <VStack w={'full'} >
            ...
            <VStack alignItems={"flex-start"} p={'8'} w={'full'} overflowY={"auto"}>
                ...
                This is called description. Lorem ipsum dolor sit, 
                 Consectetur deserunt at ullam sit soluta eveniet earum natus alias commodi. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ut omnis sint explicabo harum animi eum, sapiente perspiciatis corrupti minima reiciendis hic cum commodi nostrum eaque veniam fuga nihil tempore necessitatibus facere magni ea illum, ex eos. Minus libero, eius corporis neque, recusandae, quia fugit ipsam eaque nisi laboriosam ipsa quos. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iusto quis nam dolores! Odit nihil error nisi maiores, deserunt quod officiis quaerat perspiciatis vel dicta fugit quas alias quam necessitatibus laboriosam. </Text>
            </VStack>
        </VStack>
        <VStack w={["full",'xl']} alignItems={"stretch"} p={8} spacing={8} overflowY={'auto'} >
           { videosArr.map((e,i)=>{
            return(<Button variant={"ghost"} colorScheme="purple"  onClick={()=>setVideoSrc(e)}>
                Lecture {i+1}
            </Button>)
